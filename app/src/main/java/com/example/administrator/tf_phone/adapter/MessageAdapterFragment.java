...
public abstract class MessageAdapterFragment extends CursorAdapter {
    ...
    public MessageAdapterFragment(Context context, Cursor c) {
        super(context, c);
...
//            getContacts(context,address);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    MessageAdapterFragment.this.onClick(v, thread_id, address, finalPhoneName);
                }
            });
        }
    }
